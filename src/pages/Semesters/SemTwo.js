        ...
        <table class="w-full text-sm text-left text-gray-500 ">
          ...
          <tbody>
            <tr class="bg-white border-b">
              ...
              >
                Applied science for Electronics and Information Engineering
              </th>
              <td class="py-4 px-6">JBE1223</td>
            ...
            <tr class="bg-white border-b">
              <th
                ...
                class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
              >
                Electric Circuits and Electronic Devices Laboratory
              </th>
              <td class="py-4 px-6">JGE1213</td>
              <td class="py-4 px-6">2</td>
              <td class="py-4 px-4">
                <select
                  id="Grade"
            ...
            <tr class="bg-white border-b">
              <th
                ...
                class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
              >
                Technical English and Soft Skills II
              </th>
              <td class="py-4 px-6">JHS1221</td>
              <td class="py-4 px-6">3</td>
              <td class="py-4 px-4">
                <select
                  id="Grade"
